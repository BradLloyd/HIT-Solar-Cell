...
set QTY_MESH__1__Custom_Brad=0.000015
#set QTY_MESH__2__Custom_Brad=0.00015

set y_position__Interface__Custom=0.01
...
set ITO__Doping__Kanevce2009=1e20
...
## aSi:H(p)
set aSi_p__Thickness__Custom2021=0.07

## ITO
set ITO__Thickness__Custom2021=0.07
...
set aSi_p__Thickness=$"aSi_p__Thickness__Custom2021"
...
#set ITO__Doping=$"ITO__Doping__Kanevce2009"
set ITO__Thickness=$"ITO__Thickness__Custom2021"
...
##################################
## 1.2.2 Create Mesh From 1.2.2 ##
##################################

set y_position__ITO=$"ITO__Thickness"
set y_position__asi_p=$"y_position__ITO"+$"aSi_p__Thickness"
...
y.mesh location=0   spacing=$"vf_Mesh"
y.mesh location=$"y_position__ITO"   spacing=$"vf_Mesh"
y.mesh location=$"y_position__asi_p" spacing=$"vf_Mesh"
...
## 3.1 Region - ITO - 1
#######################
#region number=1 user.material=ITO_2 y.min=0 y.max=$"y_position__ITO"
region number=1 user.material=ITO_2 y.min=0 y.max=$"y_position__ITO"
###########################
## 3.2 Region - aSi:H(p) ##
###########################
#region number=2 user.material=paSi y.min=$"y_position__ITO" y.max=$"y_position__asi_p"
region number=2 user.material=paSi y.min=$"y_position__ITO" y.max=$"y_position__asi_p"
...
## 4. Electrodes ##
###################
#electrode num=1 name=anode   x.max=1.0 y.max=0
#electrode num=2 name=cathode y.min=$"y_position__asi_p" y.max=$"y_position__asi_p"+0.005 

electrode num=1 name=anode   top
electrode num=2 name=cathode bot
...
# Brad Adjusted
QTY.MESH LOCATION=$"y_position__ITO"-$"y_position__Interface__Custom" SPACING=$"QTY_MESH__1__Custom_Brad"
QTY.MESH LOCATION=$"y_position__ITO"+$"y_position__Interface__Custom" SPACING=$"QTY_MESH__1__Custom_Brad"
...
# odefects hopping cont nia=${aSi__nia} nid=${aSi__nid} na=${aSi__na}  nd=${aSi__nd} \
    ...
    # x.min=0.0 x.max=1.0 y.min=$"y_position__ITO" y.max=$"y_position__asi_p" \
    # numa=48 numd=48
...
#solve name=anode vanode=0.06 vstep=-0.0050 vfinal=0
#solve name=anode vanode= -0.06 vstep=0.0005 vfinal=0.02
...
solve vanode=0 name=anode vstep=-0.01 vfinal=-0.4
